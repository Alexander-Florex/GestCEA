    ...
    return (
        <div className="overflow-x-auto">
            <table className="min-w-full bg-white shadow rounded-lg overflow-hidden">
                <thead className="bg-gradient-to-r from-red-600 to-blue-600"> {/* Cambiado */}
                <tr>
                    {columns.map(col => (
                        <th
                            key={col.accessor}
                ...
                {data.map((row, idx) => (
                    ...
                    >
                        ...
                        <td className="px-4 py-3 flex space-x-2">
                            <button className="p-2 bg-blue-100 text-blue-600 rounded-full hover:bg-blue-200 transition"> {/* Cambiado */}
                                <IoEye />
                            </button>
                            <button className="p-2 bg-green-100 text-green-600 rounded-full hover:bg-green-200 transition">
                                <IoPencil />
                            </button>
                            <button className="p-2 bg-red-100 text-red-600 rounded-full hover:bg-red-200 transition"> {/* Cambiado */}
                                <IoTrash />
                            </button>
                        </td>
                    </tr>
